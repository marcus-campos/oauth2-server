...
namespace MarcusCampos\OAuth2Server;
...
use MarcusCampos\OAuth2Server\Middleware\CheckAuthCodeRequestMiddleware;
use MarcusCampos\OAuth2Server\Middleware\OAuthClientOwnerMiddleware;
use MarcusCampos\OAuth2Server\Middleware\OAuthMiddleware;
use MarcusCampos\OAuth2Server\Middleware\OAuthUserOwnerMiddleware;
